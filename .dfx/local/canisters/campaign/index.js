...
export const canisterId = process.env.CAMPAIGN_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./campaign.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the campaign canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./campaign.did.js")._SERVICE>}
 */
