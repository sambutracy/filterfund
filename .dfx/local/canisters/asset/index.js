...
export const canisterId = process.env.ASSET_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./asset.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the asset canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./asset.did.js")._SERVICE>}
 */
